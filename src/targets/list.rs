...
pub const ALL_TARGETS: &[TargetInfo] = &[
    ...
    TargetInfo {
        ...
        vendor: Some(Vendor::unknown),
        family: Some(Family::unix),
        features: Features::crt_static as u32,
        pointer_width: 64,
        endian: Endianness::little,
    },
    TargetInfo {
    ...
    TargetInfo {
        ...
        vendor: Some(Vendor::apple),
        family: Some(Family::unix),
        features: Features::fxsr as u32
            | Features::sse as u32
            | Features::sse2 as u32
            | Features::sse3 as u32,
        pointer_width: 32,
        endian: Endianness::little,
    },
    TargetInfo {
    ...
    TargetInfo {
        ...
        vendor: Some(Vendor::unknown),
        family: Some(Family::unix),
        features: Features::sse as u32
            | Features::sse2 as u32
            | Features::sse3 as u32
            | Features::ssse3 as u32,
        pointer_width: 32,
        endian: Endianness::little,
    },
    TargetInfo {
        ...
        vendor: Some(Vendor::pc),
        family: Some(Family::windows),
        features: Features::fxsr as u32 | Features::sse as u32 | Features::sse2 as u32,
        pointer_width: 32,
        endian: Endianness::little,
    },
    TargetInfo {
    ...
    TargetInfo {
        ...
        family: None,
        features: Features::fxsr as u32
            | Features::rdrand as u32
            | Features::rdseed as u32
            | Features::sse as u32
            | Features::sse2 as u32,
        pointer_width: 64,
        endian: Endianness::little,
    ...
    TargetInfo {
        ...
        family: Some(Family::unix),
        features: Features::fxsr as u32
            | Features::popcnt as u32
            | Features::sse as u32
            | Features::sse2 as u32
            | Features::sse3 as u32
            | Features::sse41 as u32
            | Features::sse42 as u32
            | Features::ssse3 as u32,
        pointer_width: 64,
        endian: Endianness::little,
    },
