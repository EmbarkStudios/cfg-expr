...
**A parser and evaluator for Rust `cfg()` expressions. Builtin targets as of [1.84.1] are supported.**
...
[![Rust Targets](https://img.shields.io/badge/Rust%20Targets-1.84.1-blue.svg)](https://forge.rust-lang.org/release/platform-support.html)
...
It contains a list of all builtin targets known to rustc as of [1.84.1] that can be used to determine if a particular cfg expression is satisfiable.
...
[1.84.1]: (https://forge.rust-lang.org/release/platform-support.html)
